...
from yuancloud.modules.module import get_module_root, MANIFEST
from yuancloud.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the YuanCloud server for your project"""
