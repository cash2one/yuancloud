...
For now, configuration code is in yuancloud.tools.config. It is in mainly
...
To initialize properly this module, yuancloud.tools.config.parse_config()
must be used.
...
# Paths to search for YuanCloud addons.
addons_paths = []
...
# installed (i.e. the majority of YuanCloud addons). This is set with the --load
# command-line option.
server_wide_modules = []
