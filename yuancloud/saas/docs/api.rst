...
To control SaaS via external tool [built-in XML-RPC](https://www.yuancloud.com/documentation/8.0/api_integration.html) can be used.
...
::
    ...
    # Define credentials
    main_url = 'http://yuancloud.local'
    main_db = 'yuancloud.local'
    ...
    client_db = 'client.yuancloud.local'
