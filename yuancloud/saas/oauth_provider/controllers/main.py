...
from yuancloud.addons.web.controllers.main import ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuth2(http.Controller):
    ...
    def _get_escaped_full_path(self, request):
        ...
        TODO: is it correct for yuancloud?
        """
    ...
    def auth(self, **kw):
        ...
        # redirect_uri: https://example.yuancloud.cn/auth_oauth/signin
        # response_type: token
