{
    ...
    'description': '''
Addon allows to users to login in yuancloud databases via master database
...
* User -- a human
* Master -- an yuancloud database where this module is installed
* Client -- an yuancloud database where you need to authenticate user and where module auth_oauth module is installed
...
From client database redirects user to url1 at master database:
    ...
    'redirect_uri': 'http://yuancloud.example.com/auth_oauth/signin',
...
then master redirects user back:
    ...
    http://yuancloud.example.com/auth_oauth/signin#access_token=ksESez4jRUxg0v6Kt7HkE5Z4ZtyrrM&token_type=Bearer&state=%7B%27p%27%3A+1%2C+%27r%27%3A+%27%252Fweb%252Flogin%253F%27%2C+%27d%27%3A+%27some-test-3%27%7D&expires_in=3600&scope=userinfo
