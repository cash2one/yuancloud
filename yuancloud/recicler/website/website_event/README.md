...
Organize, promote and sell events online. Whether you organize meetings, conferences, trainings or webinars, YuanCloud gives you all the features you need to manage your events.
...
YuanCloud's unique *'edit inline'* approach makes website creation surprisingly easy. "Want to introduce a speaker? to change the price of a ticket? to update a banner? promote sponsors?" just click and change.
...
Get a clear visibility of your sales funnel. YuanCloud's Google Analytics trackers are configured by default to track all kind of events related to shopping carts, call-to-actions, etc.

As YuanCloud marketing tools (mass mailing, campaigns, etc) are also linked with Google Analytics, you get a full view of your business.
...
### Designers love working on YuanCloud
...
SEO tools are ready to use, with no configuration required. YuanCloud suggests keywords according to Google most searched terms, Google Analytics tracks your shopping cart events and sitemap are created automatically.
...
Create new landing pages easily with the YuanCloud inline edition feature. Send visitors of your different marketing campaigns to event landing pages to optimize conversions.
