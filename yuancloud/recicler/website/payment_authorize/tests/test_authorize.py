...
from yuancloud.addons.payment_authorize.controllers.main import AuthorizeController
from yuancloud.tools import mute_logger


@yuancloud.tests.common.at_install(True)
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('yuancloud.addons.payment_authorize.models.authorize', 'ValidationError')
