yuancloud.define('survey.tour_test_survey', function (require) {
'use strict';
...
Tour.register({
    ...
    steps: [
        ...
        // Page-2
        // Question: What do you think about the documentation available on doc.yuancloud.cn?
        {
        ...
        {
            title:     "For 'I use the contextual help in YuanCloud' checking 'Agree'",
        ...
        // Question: What do you think about the process views of YuanCloud, available in the web client ?
        {
            title:     "For 'They help new users to understand YuanCloud' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to YuanCloud?
        {
