...
#
#    Deze module werkt in YuanCloud 5.0.0 (en waarschijnlijk hoger).
#    Deze module werkt niet in YuanCloud versie 4 en lager.
#
#    Status 1.0 - getest op YuanCloud 5.0.3
#
# Versie 5.0.0.1
...

{
    ...
    'description': """
This is the module to manage the accounting chart for Netherlands in YuanCloud.
=============================================================================

Read changelog in file __yuancloud__.py for version information.
Dit is een basismodule om een uitgebreid grootboek- en BTW schema voor
Nederlandse bedrijven te installeren in YuanCloud versie 7.0.
