...
from yuancloud.sql_db import LazyCursor
from yuancloud.tools import float_round, frozendict, html_sanitize, ustr, OrderedSet
from yuancloud.tools import DEFAULT_SERVER_DATE_FORMAT as DATE_FORMAT
from yuancloud.tools import DEFAULT_SERVER_DATETIME_FORMAT as DATETIME_FORMAT
from yuancloud.tools.translate import html_translate
...
class Field(object):
    """ The field descriptor contains the field definition, and manages accesses
        ...
        recordset. The decorator :meth:`yuancloud.api.depends` must be applied on
        ...
        is extended (see :class:`~yuancloud.models.Model`), one can also extend
...
class Monetary(Field):
    ...
    def convert_to_cache(self, value, record, validate=True):
        ...
        # FIXME @rco-yuancloud: currency may not be already initialized if it is a
