yuancloud.define('mass_mailing.editor', function (require) {
"use strict";
...
var _set_value = window.top.yuancloud[callback+"_updown"];
var yuancloud_top = window.top.yuancloud;
window.top.yuancloud[callback+"_updown"] = function (value, fields_values, field_name) {
    if (!window) {
        delete yuancloud_top[callback+"_updown"];
        return;
    }
    ...
    if (fields_values.mailing_model && web_editor.editor_bar) {
        ...
        if (value.indexOf('on_change_model_and_list') !== -1) {
            yuancloud_top[callback+"_downup"](_val);
        }
    }
};
