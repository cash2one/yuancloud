...
import yuancloud
from yuancloud import api, tools, SUPERUSER_ID
...
from yuancloud.tools.float_utils import float_round, float_compare
    ...
    def create_variant_ids(self, cr, uid, ids, context=None):
        ...
        for tmpl_id in tmpl_ids:
            ...
            for variant_id in map(int,variants_inactive):
                try:
                    with cr.savepoint(), tools.mute_logger('yuancloud.sql_db'):
