...
YuanCloud is an <a href="http://www.yuancloud.cn/page/e-commerce">Open Source eCommerce</a>
...
YuanCloud's unique *'edit inline'* and building blocks approach makes product pages
...
YuanCloud's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. YuanCloud's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As YuanCloud marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. YuanCloud proposes
...
SEO tools are ready to use, with no configuration required. YuanCloud suggests
...
Create new landing pages easily with the YuanCloud inline edition feature. Send
...
Benefit from the power of YuanCloud, in your online store: a powerfull tax engine,
...
Everything is integrated with YuanCloud. No pain, real time.
