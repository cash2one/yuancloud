...
from yuancloud import SUPERUSER_ID, tools
from yuancloud.osv import osv, orm, fields
...
class res_partner(yuancloud.models.Model):
    _inherit = 'res.partner'

    last_website_so_id = yuancloud.fields.Many2one('sale.order', 'Last Online Sale Order')
