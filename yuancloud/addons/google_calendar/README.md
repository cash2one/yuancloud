...
forget an event, fully synchronized with the YuanCloud <a href="http://www.yuancloud.cn/page/crm">Open Source CRM</a>.
...
You can ask to have a alarm of type 'notification' in your YuanCloud.  You will have
a notification in you YuanCloud which ever the page you are.

Google Calendar
---------------

With the plugin Google\_calendar, you can synchronize your YuanCloud calendar with Google Calendar.
