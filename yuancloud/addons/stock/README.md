YuanCloud Inventory Management
-------------------------

The YuanCloud <a href="http://www.yuancloud.cn/page/warehouse">Open Source Inventory Management</a>
is a double entry warehouse management system.

Decrease your process times, automate transactions, reduce your stock levels
and get complete traceability on all operations with the YuanCloud double entry
inventory system.

Double Entry Inventory Management
---------------------------------

Based on the concept of double entry that revolutionized accounting, YuanCloud's
...
YuanCloud prepares all operations for you, according to your own logistic rules:
...
Get your procurements accurate as the YuanCloud WMS is fully integrated with sales
...
Assign serial numbers at every step of your reception or delivery flow. YuanCloud
...
manufacturing inventories with the YuanCloud multi-warehouse management system based
on a hierarchical location structure.

YuanCloud's Inventory Management is designed to scale from a few thousands
...
the warehouse. YuanCloud supports most picking methods out-of-the-box like; wave
