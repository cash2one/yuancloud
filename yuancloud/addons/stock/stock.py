...
from yuancloud.tools.float_utils import float_compare, float_round
from yuancloud.tools.translate import _
from yuancloud.tools import DEFAULT_SERVER_DATETIME_FORMAT, DEFAULT_SERVER_DATE_FORMAT
from yuancloud import SUPERUSER_ID, api, models
import yuancloud.addons.decimal_precision as dp
from yuancloud.addons.procurement import procurement
import logging
                ...
                if product_qty < move['product_qty']:
                    warning.update({
                        ...
                        'message': _("By changing this quantity here, you accept the "
                                "new quantity as complete: YuanCloud will not "
...
class stock_warehouse_orderpoint(osv.osv):
    ...
    _columns = {
        ...
        'product_min_qty': fields.float('Minimum Quantity', required=True,
            ...
            help="When the virtual stock goes below the Min Quantity specified for this field, YuanCloud generates "\
            "a procurement to bring the forecasted quantity to the Max Quantity."),
        'product_max_qty': fields.float('Maximum Quantity', required=True,
            digits_compute=dp.get_precision('Product Unit of Measure'),
            help="When the virtual stock goes below the Min Quantity, YuanCloud generates "\
