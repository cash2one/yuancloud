...
from yuancloud.addons.payment_buckaroo.controllers.main import BuckarooController
from yuancloud.tools import mute_logger


@yuancloud.tests.common.at_install(False)
@yuancloud.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('yuancloud.addons.payment_buckaroo.models.buckaroo', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@yuancloud.cool',
