...
import yuancloud
from yuancloud.addons.base.ir.ir_qweb import AssetsBundle
from yuancloud.addons.web.controllers.main import WebClient, Binary
...
class Website(yuancloud.addons.web.controllers.main.Home):
    #------------------------------------------------------
    # View
    #------------------------------------------------------
    ...
    def sitemap_xml_index(self):
        cr, uid, context = request.cr, yuancloud.SUPERUSER_ID, request.context
    ...
    def website_info(self):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': yuancloud.service.common.exp_version()
        }
...
#------------------------------------------------------
class WebsiteBinary(yuancloud.http.Controller):
    @http.route([
        '/website/image',
        '/website/image/<xmlid>',
