...
class OgonePayment(PaymentAcquirerCommon):
    ...
    @mute_logger('yuancloud.addons.payment_ogone.models.ogone', 'ValidationError')
    ...
    def test_30_ogone_s2s(self):
        ...
        # check an alias is set, containing at least yuancloud
        tx = self.payment_transaction.browse(cr, uid, tx_id, context=context)
        self.assertIn('yuancloud', tx.partner_reference, 'ogone: wrong partner reference after creating an alias')
