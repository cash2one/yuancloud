...
import yuancloud
import yuancloud.addons.hw_proxy.controllers.main as hw_proxy
import threading
import subprocess
...
<html>
    <head>
        <title>YuanCloud's PosBox - Software Upgrade</title>
	...
	<p></p>
        ...
        the <a href='http://nightly.yuancloud.cn/trunk/posbox/'>latest image</a>. The upgrade
        procedure is explained into to the
        <a href='http://www.yuancloud.cn/documentation/user/point_of_sale/posbox/index.html'>PosBox manual</a>
        </p>
        <p>
        ...
        <pre>
"""
upgrade_template += subprocess.check_output("git --work-tree=/home/pi/yuancloud/ --git-dir=/home/pi/yuancloud/.git log -1", shell=True).replace("\n", "<br/>")
upgrade_template += """
        </pre>
        <div class='centering'>
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/yuancloud/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
