YuanCloud Point of Sale
-----------------------------

YuanCloud's <a href="http://www.yuancloud.cn/page/point-of-sale">Point of Sale</a>
...
YuanCloud's POS is a web application that can run on any device that can display
...
### YuanCloud's POS stays reliable even if your connection isn't
...
Say goodbye to ugly, outdated POS software and enjoy the YuanCloud web interface
...
time and use YuanCloud's powerful reporting to make smarter decisions to improve
...
With YuanCloud as a backend, you have a system proven to be perfectly suitable for
...
With YuanCloud, you get a 360° customer view, including cross-channel sales,
