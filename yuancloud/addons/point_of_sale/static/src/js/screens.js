yuancloud.define('point_of_sale.screens', function (require) {
"use strict";
...
var OrderWidget = PosBaseWidget.extend({
    ...
    // overriding the yuancloud framework replace method for performance reasons
    ...
    validate_order: function(force_validation) {
        ...
        if (order.is_to_invoice()) {
            ...
            invoiced.fail(function(error){
                ...
                } else if (error.code === 200) {    // YuanCloud Server Errors
