yuancloud.define('point_of_sale.models', function (require) {
"use strict";
...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        loaded: function(self){
            ...
            self.company_logo.src = '/logo.png' +'?_'+Math.random();
...
// Loads yuancloud models at the point of sale startup.
// load_models take an array of model loader declarations.
// - The models will be loaded in the array order. 
// - If no yuancloud model name is provided, no server data
...
//
// models: [{
//  model: [string] the name of the yuancloud model to load.
...
//  context: [Dict|function] the yuancloud context for the model read
