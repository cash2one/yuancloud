yuancloud.define('point_of_sale.DB', function (require) {
"use strict";
...
var PosDB = core.Class.extend({
    name: 'yuancloud_pos_db', //the prefix of the localstorage data
     ...
     * returned by the yuancloud server. Categories must be inserted before the products or the 
