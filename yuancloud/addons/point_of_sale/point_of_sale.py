...
from yuancloud import tools, models, SUPERUSER_ID
from yuancloud.osv import fields, osv
from yuancloud.tools import float_is_zero
...
class pos_config(osv.osv):
    ...
    _columns = {
        ...
        'sequence_id' : fields.many2one('ir.sequence', 'Order IDs Sequence', readonly=True,
            help="This sequence is automatically created by YuanCloud but you can change it "\
