...
class google_service(osv.osv_memory):
    ...
    def _get_authorize_uri(self, cr, uid, from_url, service, scope=False, context=None):
        """ This method return the url needed to allow this instance ofyuancloud to access to the scope of gmail specified as parameters """
    ...
    def get_base_url(self, cr, uid, context=None):
        return self.pool.get('ir.config_parameter').get_param(cr, uid, 'web.base.url', default='http://www.yuancloud.cn?NoBaseUrl', context=context)
