...
from yuancloud import api, fields, models, SUPERUSER_ID, _
from yuancloud.tools import image
from yuancloud.exceptions import Warning
...
class EmbeddedSlide(models.Model):
    ...
    slide_id = fields.Many2one('slide.slide', string="Presentation", required=True, select=1, ondelete='cascade')
