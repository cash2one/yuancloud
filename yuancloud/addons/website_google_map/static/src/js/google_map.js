function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('yuancloud-google-map'), {
        zoom: 1,
    ...
    if (yuancloud_partner_data){ /* yuancloud_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < yuancloud_partner_data.counter; i++) {
            set_marker(yuancloud_partner_data.partners[i]);
        }
