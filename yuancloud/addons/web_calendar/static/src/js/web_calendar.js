yuancloud.define('web_calendar.CalendarView', function (require) {
"use strict";
/*---------------------------------------------------------
 * YuanCloud web_calendar
 *---------------------------------------------------------*/
...
var CalendarView = View.extend({
    ...
    /**
     * Refresh one fullcalendar event identified by it's 'id' by reading YuanCloud record state.
    ...
    /**
     * Transform YuanCloud event object to fullcalendar event object
     */
    ...
    /**
     * Transform fullcalendar event object to YuanCloud Data object
     */
    ...
    /**
     * Build YuanCloud Domain to filter object by this.date_start field
