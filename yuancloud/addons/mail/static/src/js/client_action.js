yuancloud.define('mail.chat_client_action', function (require) {
"use strict";
...
var ChatAction = Widget.extend(ControlPanelMixin, {
    ...
    events: {
        ...
        "click .o_mail_request_permission": function (event) {
            ...
            if (def) {
                def.then(function () {
                    chat_manager.send_native_notification('Permission granted', 'YuanCloud has now the permission to send you native notifications on this device.');
                });
            }
        },
