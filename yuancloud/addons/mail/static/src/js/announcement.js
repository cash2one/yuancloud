yuancloud.define('mail.announcement', function (require) {
"use strict";
...
WebClient.include({
    ...
    _ab_location: function(dbuuid) {
        return _.str.sprintf('https://services.odoo.com/odoo-enterprise/ab/css/%s.css', dbuuid);
    },
        ...
        return config_parameter.call('get_param', ['database.uuid', false]).then(function(dbuuid) {
            ...
            $css.on('load', function() {
                var close = function() {
                    ...
                    $bar.slideUp();
                    setTimeout(function () {
                        $('.yuancloud_webclient_container').css('height', 'calc(100% - 34px)');                            
                    }, 400);
                };
                /*
                ...
                */
                setTimeout(function(){
                    ...
                    $('.yuancloud_webclient_container').css('height', 'calc(100% - ' + height + 'px)');
