...
class MailChatController(yuancloud.addons.bus.controllers.main.BusController):
    ...
    # --------------------------
    @yuancloud.http.route('/mail/chat_post', type="json", auth="none")
    ...
    @yuancloud.http.route(['/mail/chat_history'], type="json", auth="none")
    ...
    @yuancloud.http.route('/mail/chat_init', type="json", auth="none")
