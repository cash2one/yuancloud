...
from yuancloud import _, api, fields, models, modules, tools
from yuancloud.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from yuancloud.exceptions import UserError
from yuancloud.osv import expression

from yuancloud.addons.bus.models.bus_presence import AWAY_TIMER
