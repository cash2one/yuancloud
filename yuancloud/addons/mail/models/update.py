...
from yuancloud import release, SUPERUSER_ID
from yuancloud.models import AbstractModel
from yuancloud.tools.translate import _
from yuancloud.tools.config import config
from yuancloud.tools import misc
...
class publisher_warranty_contract(AbstractModel):
    ...
    def update_notification(self, cr, uid, ids, cron_mode=True, context=None):
        """
        Send a message to YuanCloud's publisher warranty server to check the
