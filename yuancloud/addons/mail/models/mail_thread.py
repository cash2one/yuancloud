...
from yuancloud import _, api, fields, models
from yuancloud import exceptions
from yuancloud import tools
from yuancloud.addons.mail.models.mail_message import decode
...
class MailThread(models.AbstractModel):
    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
        ...
        if ref_match:
            ...
            # do not match forwarded emails from another YuanCloud system (thread_id collision!)
    ...
    def _message_get_auto_subscribe_fields(self, updated_fields, auto_follow_fields=None):
        """ Returns the list of relational fields linking to res.users that should
            ...
            In YuanCloud V7, this is sufficent for all major addon such as opportunity,
