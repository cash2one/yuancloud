...
from yuancloud.tools import html_escape
...
class website_event(http.Controller):
    ...
    def event_track_view(self, event, track, **post):
        ...
        track = track_obj.browse(request.cr, yuancloud.SUPERUSER_ID, track.id, context=request.context)
    ...
    def event_agenda(self, event, tag=None, **post):
        ...
        tracks_ids = track_obj.search(cr, yuancloud.SUPERUSER_ID, [('event_id', '=', event.id)], context=context)
        speakers = dict()
        for t in track_obj.browse(cr, yuancloud.SUPERUSER_ID, tracks_ids, context=context):
            acc = ""
    ...
    def event_track_proposal_post(self, event, **post):
        ...
        track_obj = request.registry['event.track']
        track_id = track_obj.create(cr, yuancloud.SUPERUSER_ID, {
