...
from yuancloud.sql_db import TestCursor
from yuancloud.tools import config
from yuancloud.tools.misc import find_in_path
...
#--------------------------------------------------------------------------
# Check the presence of Wkhtmltopdf and return its version at YuanCloud start-up
#--------------------------------------------------------------------------
...
try:
    ...
    if config['workers'] == 1:
        _logger.info('You need to start YuanCloud with at least two workers to print a pdf version of the reports.')
