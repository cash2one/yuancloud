yuancloud.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.yuancloud[callback+"_updown"] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.yuancloud[callback+"_editor"]) {
                window.top.yuancloud[callback+"_editor"](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.yuancloud[callback+"_downup"]) {
                    window.top.yuancloud[callback+"_downup"]($editable.prop('innerHTML'));
                }
            });
        });
