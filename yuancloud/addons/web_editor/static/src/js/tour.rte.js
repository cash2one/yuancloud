yuancloud.define('web_editor.tour', function (require) {
'use strict';
    ...
    steps: [
        {
            ...
            onload: function () {
                var html = '\n'+
                    ...
                    '        </div>\n'+
                    '        <div class="col-md-6 mt16">\n'+
                    '            <img class="img img-responsive shadow mb16" src="/web_editor/static/src/img/drag_here.png" alt="YuanCloud text and image block">\n'+
                    '        </div>\n'+
                    '    </div>\n'+
                    '</section>\n';
        ...
        },
        {
            ...
            sampleText: "http://www.yuancloud.cn",
    ...
    steps: [
        {
            ...
            onload: function () {
                ...
                var html = '\n'+
                    ...
                    '        </td>\n'+
                    '        <td valign="center" width="270">\n'+
                    '          <a href="https://www.facebook.com/YuanCloud"><span class="fa fa-facebook-square fa-2x text-primary"></span></a>\n'+
