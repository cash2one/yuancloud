define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // YuanCloud: allow access for override
    this.table = table;   // YuanCloud: allow access for override
    this.typing = typing; // YuanCloud: allow access for override
    this.bullet = bullet; // YuanCloud: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // YuanCloud: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // YuanCloud: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var className = linkInfo.className || null; // YuanCloud: addition
      ...
      var anchors = [];
      // YuanCloud: adding this branch to modify existing anchor
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', className); // YuanCloud: addition
        if (isNewWindow) {
