define(['summernote/core/range', 'summernote/core/dom'], function (range, dom) { // YuanCloud: suggest upstream
  /**
  ...
  var History = function ($editable) {
    ...
    var makeSnapshot = function () {
      ...
      return {
        ...
        // YuanCloud: suggest upstream added " && dom.ancestor(rng.sc, dom.isEditable) "
      };
    };
    ...
    var last; // YuanCloud: to suggest upstream (since we may have several editor)
    /**
     * recorded undo
     */
    this.recordUndo = function () {
      // YuanCloud: method totally rewritten
