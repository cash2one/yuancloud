...
from yuancloud.addons.payment_adyen.controllers.main import AdyenController
...
class AdyenForm(AdyenCommon):
    ...
    # @mute_logger('yuancloud.addons.payment_adyen.models.adyen', 'ValidationError')
