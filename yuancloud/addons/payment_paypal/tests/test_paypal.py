...
from yuancloud.addons.payment.tests.common import PaymentAcquirerCommon
from yuancloud.addons.payment_paypal.controllers.main import PaypalController
...
class PaypalCommon(PaymentAcquirerCommon):
    ...
    def setUp(self):
        ...
        # tde+seller@yuancloud.cool - tde+buyer@yuancloud.cool - tde+buyer-it@yuancloud.cool
...
class PaypalForm(PaypalCommon):
    ...
    def test_10_paypal_form_render(self):
        ...
        self.payment_acquirer.write(cr, uid, self.paypal_id, {'paypal_email_account': 'tde+paypal-facilitator@yuancloud.cool', 'fees_active': False}, context)
        ...
        form_values = {
            'cmd': '_xclick',
            'business': 'tde+paypal-facilitator@yuancloud.cool',
    ...
    @mute_logger('yuancloud.addons.payment_paypal.models.paypal', 'ValidationError')
    def test_20_paypal_form_management(self):
        ...
        paypal_post_data = {
            ...
            'mc_currency': u'EUR',
            'shipping': u'0.00',
            'payer_email': u'tde+buyer@yuancloud.cool',
