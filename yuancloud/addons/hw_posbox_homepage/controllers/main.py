...
""" + index_style + """
    ...
    <body>
        ...
        receipt printers and barcode scanners with YuanCloud's Point of
        Sale, <b>version 8.0 or later</b>. You can start an <a href='http://www.yuancloud.cn/start'>online free trial</a>,
        or <a href='http://www.yuancloud.cn/start?download'>download and install</a> it yourself.
        </p>
        <p>
        For more information on how to setup the Point of Sale with
        the PosBox, please refer to
        <a href='http://www.yuancloud.cn/documentation/user/point_of_sale/posbox/index.html'>the manual</a>.
        </p>
        <p>
        ...
        the posbox version number is independent from YuanCloud. You can upgrade
        the software on the <a href='/hw_proxy/upgrade/'>upgrade page</a>.
        </p>
        <p>For any other question, please contact the YuanCloud support at <a href='mailto:support@yuancloud.cool'>support@yuancloud.cool</a>
        </p>
    </body>
</html>
...
class PosboxHomepage(yuancloud.addons.web.controllers.main.Home):
...
"""
    ...
    def connect_to_wifi(self, essid, password, persistent=False):
        ...
        subprocess.call(['/home/pi/yuancloud/addons/point_of_sale/tools/posbox/configuration/connect_to_wifi.sh', essid, password, persistent])
        return "connecting to " + essid

    @http.route('/wifi_clear', type='http', auth='none', cors='*')
    def clear_wifi_configuration(self):
        os.system('/home/pi/yuancloud/addons/point_of_sale/tools/posbox/configuration/clear_wifi_configuration.sh')
