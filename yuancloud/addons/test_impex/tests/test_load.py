...
from yuancloud.tests import common
from yuancloud.tools.misc import mute_logger
...
class ImporterCase(common.TransactionCase):
    ...
    def import_(self, fields, rows, context=None):
        return self.model.load(
            self.cr, yuancloud.SUPERUSER_ID, fields, rows, context=context)
    def read(self, fields=('value',), domain=(), context=None):
        return self.model.read(
            self.cr, yuancloud.SUPERUSER_ID,
            self.model.search(self.cr, yuancloud.SUPERUSER_ID, domain, context=context),
    ...
    def xid(self, record):
        ...
        if ids:
            d = ModelData.read(
                self.cr, yuancloud.SUPERUSER_ID, ids, ['name', 'module'])[0]
            if d['module']:
        ...
        name = name.replace('.', '-')
        ModelData.create(self.cr, yuancloud.SUPERUSER_ID, {
            'name': name,
            'model': record._name,
            'res_id': record.id,
            'module': '__test__'
    ...
    def add_translations(self, name, type, code, *tnx):
        ...
        if not Lang.search(self.cr, yuancloud.SUPERUSER_ID, [('code', '=', code)]):
            Lang.create(self.cr, yuancloud.SUPERUSER_ID, {
                'name': code,
                'code': code,
                'translatable': True,
                'date_format': '%d.%m.%Y',
        ...
        for source, value in tnx:
            Translations.create(self.cr, yuancloud.SUPERUSER_ID, {
                'name': name,
                'lang': code,
                'type': type,
                'src': source,
...
class test_ids_stuff(ImporterCase):
    ...
    def test_update_with_id(self):
        id = self.model.create(self.cr, yuancloud.SUPERUSER_ID, {'value': 36})
        self.assertEqual(
            36,
            self.model.browse(self.cr, yuancloud.SUPERUSER_ID, id).value)
...
class test_integer_field(ImporterCase):
    ...
    @mute_logger('yuancloud.sql_db', 'yuancloud.models')
...
class test_m2o(ImporterCase):
    ...
    def test_by_name(self):
        ...
        integer_id1 = self.registry('export.integer').create(
            self.cr, yuancloud.SUPERUSER_ID, {'value': 42})
        integer_id2 = self.registry('export.integer').create(
            self.cr, yuancloud.SUPERUSER_ID, {'value': 36})
        # get its name
        name1 = dict(self.registry('export.integer').name_get(
            self.cr, yuancloud.SUPERUSER_ID,[integer_id1]))[integer_id1]
        name2 = dict(self.registry('export.integer').name_get(
            self.cr, yuancloud.SUPERUSER_ID,[integer_id2]))[integer_id2]
    ...
    def test_by_xid(self):
        ...
        xid = self.xid(ExportInteger.browse(
            self.cr, yuancloud.SUPERUSER_ID, [integer_id])[0])
...
class test_m2m(ImporterCase):
    ...
    def test_ids(self):
        id1 = self.registry('export.many2many.other').create(
                self.cr, yuancloud.SUPERUSER_ID, {'value': 3, 'str': 'record0'})
        id2 = self.registry('export.many2many.other').create(
                self.cr, yuancloud.SUPERUSER_ID, {'value': 44, 'str': 'record1'})
        id3 = self.registry('export.many2many.other').create(
                self.cr, yuancloud.SUPERUSER_ID, {'value': 84, 'str': 'record2'})
        id4 = self.registry('export.many2many.other').create(
                self.cr, yuancloud.SUPERUSER_ID, {'value': 9, 'str': 'record3'})
        id5 = self.registry('export.many2many.other').create(
                self.cr, yuancloud.SUPERUSER_ID, {'value': 99, 'str': 'record4'})
    ...
    def test_xids(self):
        ...
        id1 = M2O_o.create(self.cr, yuancloud.SUPERUSER_ID, {'value': 3, 'str': 'record0'})
        id2 = M2O_o.create(self.cr, yuancloud.SUPERUSER_ID, {'value': 44, 'str': 'record1'})
        id3 = M2O_o.create(self.cr, yuancloud.SUPERUSER_ID, {'value': 84, 'str': 'record2'})
        id4 = M2O_o.create(self.cr, yuancloud.SUPERUSER_ID, {'value': 9, 'str': 'record3'})
        records = M2O_o.browse(self.cr, yuancloud.SUPERUSER_ID, [id1, id2, id3, id4])
...
class test_o2m(ImporterCase):
    ...
    def test_link_inline(self):
        ...
        """
        id1 = self.registry('export.one2many.child').create(self.cr, yuancloud.SUPERUSER_ID, {
            'str': 'Bf', 'value': 109
        })
        id2 = self.registry('export.one2many.child').create(self.cr, yuancloud.SUPERUSER_ID, {
            'str': 'Me', 'value': 262
        })
    ...
    def test_link(self):
        ...
        id1 = O2M.create(self.cr, yuancloud.SUPERUSER_ID, {
            'str': 'Bf', 'value': 109
        })
        id2 = O2M.create(self.cr, yuancloud.SUPERUSER_ID, {
            'str': 'Me', 'value': 262
        })
    ...
    def test_link_2(self):
        ...
        id1 = O2M_c.create(self.cr, yuancloud.SUPERUSER_ID, {
            'str': 'Bf', 'value': 109
        })
        id2 = O2M_c.create(self.cr, yuancloud.SUPERUSER_ID, {
            'str': 'Me', 'value': 262
        })
...
class test_realworld(common.TransactionCase):
    ...
    def test_recursive_o2m(self):
        ...
        result = Model.load(self.cr, yuancloud.SUPERUSER_ID,
        ...
        b = Model.browse(self.cr, yuancloud.SUPERUSER_ID, result['ids'], context=None)
...
class test_datetime(ImporterCase):
    ...
    def test_checktz1(self):
        ...
        self.registry('res.users').write(
            self.cr, yuancloud.SUPERUSER_ID, [yuancloud.SUPERUSER_ID],
            {'tz': 'Asia/Hovd'})
