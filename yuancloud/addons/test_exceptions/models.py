# -*- coding: utf-8 -*-
import yuancloud.exceptions
import yuancloud.osv.orm
import yuancloud.osv.osv
import yuancloud.tools.safe_eval
from yuancloud.exceptions import UserError
from yuancloud.exceptions import except_orm

class m(yuancloud.osv.osv.Model):
    ...
    def generate_except_osv(self, cr, uid, ids, context=None):
        ...
        raise yuancloud.osv.osv.except_osv('title', 'description')
    ...
    def generate_warning(self, cr, uid, ids, context=None):
        raise yuancloud.exceptions.Warning('description')
    ...
    def generate_redirect_warning(self, cr, uid, ids, context=None):
        ...
        raise yuancloud.exceptions.RedirectWarning('description', action_id, 'Go to the redirection')
    ...
    def generate_access_error(self, cr, uid, ids, context=None):
        raise yuancloud.exceptions.AccessError('description')
    ...
    def generate_missing_error(self, cr, uid, ids, context=None):
        raise yuancloud.exceptions.MissingError('description')

    def generate_validation_error(self, cr, uid, ids, context=None):
        raise yuancloud.exceptions.ValidationError('description')
    ...
    def generate_safe_eval(self, cr, uid, ids, f, context):
        ...
        yuancloud.tools.safe_eval.safe_eval("generate()", mode='exec', globals_dict=globals_dict)
