yuancloud.define('web.ControlPanelMixin', function (require) {
"use strict";
...
yuancloud.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {yuancloud.web.SearchView} [status.searchview] the searchview widget
     ...
     * @param {yuancloud.web.SearchView} [searchview] the searchview Widget
