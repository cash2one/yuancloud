yuancloud.define('web.FormView', function (require) {
"use strict";
...
var FormView = View.extend(common.FieldManagerMixin, {
     ...
     *
     * @param {instance.web.Session} session the current yuancloud session
     * @param {instance.web.DataSet} dataset the dataset this view will work with
     * @param {String} view_id the identifier of the YuanCloud view object
     *
    ...
    record_created: function(r, prepend_on_create) {
        ...
        if (!r) {
            ...
            //yuancloud.log("The record has been created with id #" + this.datarecord.id);
