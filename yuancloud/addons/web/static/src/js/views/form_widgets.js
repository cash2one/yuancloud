yuancloud.define('web.form_widgets', function (require) {
"use strict";
    ...
    render_value: function() {
        ...
        if(this.check_timezone()){
            var options = _.extend({
                ...
                title: _t("Timezone Mismatch : The timezone of your browser doesn't match the selected one. The time in YuanCloud is displayed according to your field timezone."),
            });
...
var FieldBinary = common.AbstractField.extend(common.ReinitializeFieldMixin, {
    ...
    on_file_uploaded: function(size, name, content_type, file_base64) {
        if (size === false) {
            ...
            // TODO: use yuancloud web crashmanager
...
var FieldStatus = common.AbstractField.extend({
    ...
    /*
     * :deprecated: this feature will probably be removed with YuanCloud v8
     */
 ...
 * will substitute to the <field> tags as defined in YuanCloud's views.
 */
 ...
 * tags defined in YuanCloud's form views.
 *
