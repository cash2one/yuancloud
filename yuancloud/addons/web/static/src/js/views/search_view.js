yuancloud.define('web.SearchView', function (require) {
"use strict";
...
var SearchView = Widget.extend(/** @lends instance.web.SearchView# */{
    ...
    /**
     * @param {yuancloud.web.search.SearchQuery | undefined} Undefined if event is change
     * @param {yuancloud.web.search.Facet}
     * @param {Object} [options]
     */
