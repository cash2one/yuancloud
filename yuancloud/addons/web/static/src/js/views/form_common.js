yuancloud.define('web.form_common', function (require) {
"use strict";
 ...
 *     This event is not related to the on_change mechanism of YuanCloud and is always called
...
var FieldManagerMixin = {
    ...
    */
    ...
    /**
    Computes an YuanCloud domain.

    @param {Array} expression An YuanCloud domain.
    ...
    */
    ...
    @return {CompoundContext} An YuanCloud context.
    */
...
var FieldInterface = {
     ...
     * osv class in the YuanCloud server as well as the syntax used by the set_value() (see below). It must
     ...
     * the YuanCloud server, although it is not assumed to respect the constraints applied to the field.
...
var AbstractField = FormWidget.extend(FieldInterface, {
    ...
    */
     ...
     * value is similar to false in YuanCloud.
     */
    is_false: function() {
