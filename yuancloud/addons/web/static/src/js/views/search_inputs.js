yuancloud.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` YuanCloud field type:
 *
...
/**
 * Implementation of the ``datetime`` yuancloud field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {yuancloud.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the YuanCloud filters (button with a context and/or
