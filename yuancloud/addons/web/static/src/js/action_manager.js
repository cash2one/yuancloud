yuancloud.define('web.ActionManager', function (require) {
"use strict";
...
var ActionManager = Widget.extend({
     ...
     *
     * widget: typically, widgets added are yuancloud.web.ViewManager. The action manager
