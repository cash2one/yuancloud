yuancloud.define('web.mixins', function (require) {
"use strict";
...
function yuancloudEvent (target, name, data) {
    this.target = target;
    this.name = name;
...
yuancloudEvent.prototype.stop_propagation = function () {
    this.stopped = true;
};

yuancloudEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function(name, info) {
        var event = new yuancloudEvent(this, name, info);
