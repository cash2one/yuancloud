yuancloud.define('web.time', function (require) {
"use strict";
 ...
 * datetime in the YuanCloud Server format.
 *
...
/**
 * Converts a string to a Date javascript object using YuanCloud's
 * datetime string format (exemple: '2011-12-01 15:12:35.832').
 * 
 * The time zone is assumed to be UTC (standard for YuanCloud 6.1)
 ...
 * 
 * The YuanCloud times are supposed to always be naive times. We assume it is
...
/**
 * Converts a Date javascript object to a string using YuanCloud's
 * datetime string format (exemple: '2011-12-01 15:12:35').
 * 
 * The time zone of the Date object is assumed to be the one of the
 * browser and it will be converted to UTC (standard for YuanCloud 6.1).
 * 
 * @param {Date} obj
...
var normalize_format_table = {
    ...
    // See yuancloud/addons/base/res/res_lang_view.xml
