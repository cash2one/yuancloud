...
yuancloud.define('web.translation', function (require) {
"use strict";
...
var TranslationDataBase = Class.extend(/** @lends instance.TranslationDataBase# */{
    ...
    /**
        Loads the translations from an YuanCloud server.

        @param {yuancloud.Session} session The session object to contact the server.
