yuancloud.define('web.framework', function (require) {
"use strict";
...
var messages_by_seconds = function() {
    return [
        [0, _t("Cargando...")],
        [15, _t("Aun esta cargando...")],
        [45, _t("Aun esta cargando...<br />Ten un poco de paciencia")],
        [90, _t("Este proceso esta demorado,<br />Pero aun sigue cargando...")],
        [180, _t("Tomate un par de minutos para ir por un cafe,<br />esto sigue trabajando...")],
        [360, _t("Aunque no lo creas,<br />pero el sistema aun esta trabajando...")],
        [3600, _t("Tal vez usted debería considerar volver a cargar la aplicación pulsando F5 ...")]
    ];
};
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="yuancloud oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the yuancloud server to be reachable before reloading
...
$.fn.yuancloudClass = function(additionalClass) {
    // This plugin should be applied on top level elements
    additionalClass = additionalClass || '';
    if (!!$.browser.msie) {
        additionalClass += ' yuancloud_ie';
    }
    return this.each(function() {
        $(this).addClass('yuancloud ' + additionalClass);
    });
};
$.fn.yuancloudBounce = function() {
    return this.each(function() {
...
yuancloud.define('web.IFrameWidget', function (require) {
"use strict";
