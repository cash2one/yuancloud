yuancloud.define('web.crash_manager', function (require) {
    var CrashManager = require('web.CrashManager');
    return new CrashManager();
});

yuancloud.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "yuancloud.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: "Session Expired", data: { message: _t("Your YuanCloud session expired. Please refresh the current web page.") }});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        new Dialog(this, {
            size: 'medium',
            title: "YuanCloud " + (_.str.capitalize(error.type) || _t("Warning")),
    ...
    show_error: function(error) {
        ...
        new Dialog(this, {
            title: "YuanCloud " + _.str.capitalize(error.type),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: "YuanCloud " + (_.str.capitalize(error.type) || "Warning"),
            buttons: [
...
core.crash_registry.add('yuancloud.exceptions.RedirectWarning', RedirectWarningHandler);
