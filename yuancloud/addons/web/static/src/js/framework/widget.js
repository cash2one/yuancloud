yuancloud.define('web.Widget', function (require) {
"use strict";
 ...
 *
 * MyWidget = yuancloud.base.Widget.extend({
...
var Widget = core.Class.extend(mixins.PropertiesMixin, {
     ...
     *
     * @constructs yuancloud.Widget
     *
     * @param {yuancloud.Widget} parent Binds the current instance to the given Widget instance.
     ...
     * yuancloud Web where developers may want to replace existing callbacks with
     * theirs.
     *
