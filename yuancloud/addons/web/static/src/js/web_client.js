yuancloud.define('web.WebClient', function (require) {
"use strict";
...
var WebClient = Widget.extend({
    ...
    init: function(parent, client_options) {
        ...
        this.set('title_part', {"zyuancloud": "YuanCloud"});
    },
    start: function() {
        var self = this;
    ...
    bind_events: function() {
        ...
        /*
            Small patch to allow having a link with a href towards an anchor. Since yuancloud use hashtag 
    ...
    */
    ...
    on_connection_lost: function () {
        this.connection_notification = this.notification_manager.notify(
            _t('我们遭遇一个问题,连接丢失'),
            _t('yuancloud正在尝试重新连接，请检查您的网络连接'),
            true
        );
    },
