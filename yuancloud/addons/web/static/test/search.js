yuancloud.define_section('search.query', ['web.SearchView'], function (test) {
...
yuancloud.define_section('search.defaults', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
yuancloud.define_section('search.completions', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
    ...
    test('facet selection', function (assert) {
        ...
        var completion = {
            ...
            facet: {
                field: {
                    get_domain: yuancloud.testing.noop,
                    get_context: yuancloud.testing.noop,
                    get_groupby: yuancloud.testing.noop
                },
                category: 'Dummy',
                values: [{label: 'dummy', value: 42}]
            }
...
yuancloud.define_section('search.serialization', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
yuancloud.define_section('search.filters', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
    function setup () {
        mock.add('dummy.model:fields_view_get', function () {
...
yuancloud.define_section('search.groupby', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
yuancloud.define_section('search.filters.saved', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
yuancloud.define_section('search.advanced', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
