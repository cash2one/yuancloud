yuancloud.define_section('class', ['web.Class'], function (test) {
...
yuancloud.define_section('Widget.proxy', ['web.Widget'], function (test) {
...
yuancloud.define_section('Widget.renderElement', ['web.Widget'], function (test) {
...
yuancloud.define_section('Widget.$', ['web.Widget', 'web.core'], function (test) {
...
yuancloud.define_section('Widget.events', ['web.Widget', 'web.core'], function (test) {
    function setup(qweb) {
       qweb.add_template(
            '<no>' +
                '<t t-name="test.widget.template">' +
...
yuancloud.define_section('Widget.async', ['web.Widget'], function (test) {
...
yuancloud.define_section('server-formats', ['web.time'], function (test) {
