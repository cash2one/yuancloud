yuancloud.define_section('editor', ['web.ListEditor'], function (test, mock) {
...
yuancloud.define_section('list.edition', ['web.data', 'web.ListView'], function (test, mock) {
...
yuancloud.define_section('list.edition.events', ['web.data', 'web.ListView'], function (test, mock) {
...
yuancloud.define_section('list.edition.onwrite', ['web.data', 'web.ListView'], function (test, mock) {
