...
:js:class:`yuancloud.web.list.Column` objects allowing for the
...
.. js:class:: yuancloud.web.list.Column(id, tag, attrs)

    .. js:function:: yuancloud.web.list.Column.format(record_data, options)
        ...
        Otherwise calls :js:func:`~yuancloud.web.list.Column._format`
        ...
        :js:func:`~yuancloud.web.list.Column._format` instead.

        :returns: String

    .. js:function:: yuancloud.web.list.Column._format(record_data, options)

        Never called directly, called if the column is visible and has
        a value.

        The default implementation calls
        :js:func:`~yuancloud.web.format_value` and htmlescapes the
        result (via ``_.escape``).

        Note that the implementation of
        :js:func:`~yuancloud.web.list.Column._format` *must* escape the
        data provided to it, its output will *not* be escaped by
        :js:func:`~yuancloud.web.list.Column.format`.
...
:js:func:`~yuancloud.web.ListView.editable` method, will return a falsy
...
``context.set_editable``
    ...
    :js:func:`~yuancloud.web.ListView.do_search`` handler), ``true``
...
.. js:function:: yuancloud.web.ListView.ensure_saved
...
.. js:function:: yuancloud.web.ListView.start_edition([record][, options])
    ...
    :type record: :js:class:`~yuancloud.web.list.Record`
    :param EditOptions options:
    :returns: delegate to the form used for the edition

.. js:function:: yuancloud.web.ListView.save_edition
...
.. js:function:: yuancloud.web.ListView.cancel_edition([force=false])
...
.. js:function:: yuancloud.web.ListView.get_cells_for(row)
...
.. js:function:: yuancloud.web.ListView.with_event(event_name, event, action[, args][, trigger_params])
...
.. js:function:: yuancloud.web.ListView.handle_onwrite(record)
    ...
    :param record: record being written having triggered the
                   ``onwrite`` callback
    :type record: yuancloud.web.list.Record
...
:js:class:`~yuancloud.web.list.Editor`.

.. js:class:: yuancloud.web.list.Editor(parent[, options])
    ...
    e.g. :js:func:`~yuancloud.web.list.Editor.edit` multiple times in a
    row without saving or cancelling each edit is undefined.

    :param parent:
    :type parent: :js:class:`~yuancloud.web.Widget`
    :param EditorOptions options:

    .. js:function:: yuancloud.web.list.Editor.is_editing([record_state])
    ...
    .. js:function:: yuancloud.web.list.Editor.edit(record, configureField[, options])
        ...
        :type configureField: Function<String, yuancloud.web.form.Field>
        :param EditOptions options:
        :returns: jQuery delegate to the form object

    .. js:function:: yuancloud.web.list.Editor.save
    ...
    .. js:function:: yuancloud.web.list.Editor.cancel([force=false])
...
.. js:class:: EditorOptions
    ...
    .. js:attribute:: EditorOptions.formView
        ...
        By default, :js:class:`~yuancloud.web.FormView`
...
.. js:class:: EditorDelegate
    ...
    the :js:class:`~yuancloud.web.list.Editor`'s delegate.
    ...
    .. js:function:: EditorDelegate.edition_view(editor)
        ...
        Called by the :js:class:`~yuancloud.web.list.Editor` object to
        ...
        :type editor: :js:class:`~yuancloud.web.list.Editor`
        :returns: form view
        :rtype: Object

    .. js:function:: EditorDelegate.prepends_on_create

        By default, the :js:class:`~yuancloud.web.list.Editor` will
...
* The editable listview behavior has been rewritten pretty much from
  ...
  * The overloading of :js:class:`~yuancloud.web.ListView.Groups` and
    :js:class:`~yuancloud.web.ListView.List` for editability has been
    drastically simplified, and most of the behavior has been moved to
    the list view itself. Only
    :js:func:`~yuancloud.web.ListView.List.row_clicked` is still
    overridden.
...
* :js:func:`~yuancloud.web.ListView.do_button_action`'s core behavior
  has been split away to
  :js:func:`~yuancloud.web.ListView.handle_button`. This allows bypassing
  overrides of :js:func:`~yuancloud.web.ListView.do_button_action` in a
  parent class.

  Ideally, :js:func:`~yuancloud.web.ListView.handle_button` should not be
  overridden.
