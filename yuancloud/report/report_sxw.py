...
from yuancloud.osv.fields import float as float_field, function as function_field, datetime as datetime_field
from yuancloud.tools.translate import _
from yuancloud.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT
...
class report_sxw(report_rml, preprocess.report):
    ...
    yuancloud.netsvc.LocalService() indirection and the related
    yuancloud.report.interface.report_int._reports dictionary:
