...
from yuancloud.report.render.rml2pdf import customfonts
...
class report_int(object):
    ...
    def __init__(self, name, register=True):
        if register:
            assert yuancloud.conf.deprecation.allow_report_int_registration
...
class report_rml(report_int):
    ...
    def create(self, cr, uid, ids, datas, context):
        ...
        self.title = report_xml_ids and ir_actions_report_xml_obj.browse(cr,uid,report_xml_ids)[0].name or 'YuanCloud Report'
    ...
    def post_process_xml_data(self, cr, uid, xml, context=None):
        ...
        tmpl_path = yuancloud.modules.get_module_resource('base', 'report', 'corporate_defaults.xml')
