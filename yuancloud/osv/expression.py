...
term representation was ['=', 'company_id.name', 'YuanCloud']. Used in a
...
YuanCloud will use the SQL function 'unaccent' when available for the
...
Finally, to instruct YuanCloud to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if yuancloud.modules.registry.RegistryManager.get(cr.dbname).has_unaccent:
