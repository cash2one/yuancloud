...
###################################################################
    ...
    def get_part_data_transfer(self):
        """
            Map yuancloud vs. destination Part data transfer fields
        """
        return {
    ...
    def get_bom_data_transfer(self):
        """
            Map yuancloud vs. destination BoM data transfer fields
        """
        return {
    ...
    def get_data_transfer(self):
        """
            Map yuancloud vs. destination Connection DB data transfer values
        """
        return {
            'db':
            {
