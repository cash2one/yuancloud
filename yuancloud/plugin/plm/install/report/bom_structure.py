...
#    2 - Compile to bom_structure.rml using ..\base_report_designer\yuancloud_sxw2rml\yuancloud_sxw2rml.py
#           python yuancloud_sxw2rml.py bom_structure.sxw > bom_structure.rml
#
##############################################################################
import os
import time
...
from yuancloud.report import report_sxw
...
report_sxw.report_sxw('report.plm.bom.structure.all','mrp.bom','/'+yuancloudModule+'/install/report/'+thisModule+'.rml',parser=bom_structure_all_custom_report,header='internal')
...
report_sxw.report_sxw('report.plm.bom.structure.one','mrp.bom','/'+yuancloudModule+'/install/report/'+thisModule+'.rml',parser=bom_structure_one_custom_report,header='internal')
...
report_sxw.report_sxw('report.plm.bom.structure.all.sum','mrp.bom','/'+yuancloudModule+'/install/report/'+thisModule+'.rml',parser=bom_structure_all_sum_custom_report,header='internal')
...
report_sxw.report_sxw('report.plm.bom.structure.one.sum','mrp.bom','/'+yuancloudModule+'/install/report/'+thisModule+'.rml',parser=bom_structure_one_sum_custom_report,header='internal')
...
report_sxw.report_sxw('report.plm.bom.structure.leaves','mrp.bom','/'+yuancloudModule+'/install/report/'+thisModule+'.rml',parser=bom_structure_leaves_custom_report,header='internal')
...
report_sxw.report_sxw('report.plm.bom.structure.flat','mrp.bom','/'+yuancloudModule+'/install/report/'+thisModule+'.rml',parser=bom_structure_flat_custom_report,header='internal')
