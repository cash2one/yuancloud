...
yuancloudModulePath=_modulePath()
...
if not os.path.exists(header_file):
    header_file=os.path.join(yuancloudModulePath,"spare_parts_header.rml")

body_file=os.path.join(customModulePath,"spare_parts_body.rml")
if not os.path.exists(body_file):
    body_file=os.path.join(yuancloudModulePath,"spare_parts_body.rml")
